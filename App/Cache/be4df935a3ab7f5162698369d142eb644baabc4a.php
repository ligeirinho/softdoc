<!--
 * @view  tipos/index.blade.php
 * @created  at 03-11-2016 12:53:21
 * - Criado Automaticamente pelo HTR Assist
 -->



<?php $__env->startSection('title', 'Lista de Tipos'); ?>
...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h3>Tipos</h3>
                <i class="fa fa-list"></i> Lista de Tipos<br>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($value['nome_tipo']); ?></td>
                            <td><?php echo e($value['criado']); ?></td>
                            <td><?php echo e($value['atualizado']); ?></td>
                            <td>
