<?php
/**
 * @Controller LogdocumentosController
...
use App\Models\LogdocumentosModel;

class LogdocumentosController extends Controller implements ControllerInterface
{
    ...
    public function __construct($auth)
    {
        ...
        $this->view['controller'] = APPDIR . 'Logdocumentos/';

        $this->modelDefault = LogdocumentosModel::class;
    ...
    public function novoAction()
    {
        ...
        // relação com model SoftdocAcaoModel
        $softdocAcaoModel = new \App\Models\SoftdocAcaoModel($this->access->pdo);
        $this->view['resultSoftdocAcao'] = $softdocAcaoModel->returnAll();
        ...
        $this->render('Logdocumentos.form_novo');
    }
    ...
    public function editarAction()
    {
        ...
        $this->render('Logdocumentos.form_editar');
    }
    ...
    public function visualizarAction()
    {
        ...
        $this->render('Logdocumentos.index');
    }
